...
`,[eo(),N("dropdown-option",`
 ...
 padding: var(--n-padding);
 `)])]),Po={animated:{type:Boolean,default:!0},keyboard:{type:Boolean,default:!0},size:{type:String,default:"medium"},inverted:Boolean,placement:{type:String,default:"bottom"},onSelect:[Function,Array],options:{type:Array,default:()=>[]},menuProps:Function,showArrow:Boolean,renderLabel:Function,renderIcon:Function,renderOption:Function,nodeProps:Function,labelField:{type:String,default:"label"},keyField:{type:String,default:"key"},childrenField:{type:String,default:"children"},value:[String,Number]},Ro=Object.keys(Pe),$o=Object.assign(Object.assign(Object.assign({},Pe),Po),Ne.props),Io=D({name:"Dropdown",inheritAttrs:!1,props:$o,setup(e){const o=F(!1),r=to(O(e,"show"),o),i=y(()=>{const{keyField:l,childrenField:w}=e;return ro(e.options,{getKey(f){return f[l]},getDisabled(f){return f.disabled===!0},getIgnored(f){return f.type==="divider"||f.type==="render"},getChildren(f){return f[w]}})}),t=y(()=>i.value.treeNodes),n=F(null),d=F(null),c=F(null),a=y(()=>{var l,w,f;return(f=(w=(l=n.value)!==null&&l!==void 0?l:d.value)!==null&&w!==void 0?w:c.value)!==null&&f!==void 0?f:null}),x=y(()=>i.value.getPath(a.value).keyPath),b=y(()=>i.value.getPath(e.value).keyPath),S=oe(()=>e.keyboard&&r.value);ho({keydown:{ArrowUp:{prevent:!0,handler:ae},ArrowRight:{prevent:!0,handler:Y},ArrowDown:{prevent:!0,handler:de},ArrowLeft:{prevent:!0,handler:ie},Enter:{prevent:!0,handler:le},Escape:Q}},S);const{mergedClsPrefixRef:P,inlineThemeDisabled:h}=ke(e),_=Ne("Dropdown","-dropdown",No,io,e,P);W(re,{labelFieldRef:O(e,"labelField"),childrenFieldRef:O(e,"childrenField"),renderLabelRef:O(e,"renderLabel"),renderIconRef:O(e,"renderIcon"),hoverKeyRef:n,keyboardKeyRef:d,lastToggledSubmenuKeyRef:c,pendingKeyPathRef:x,activeKeyPathRef:b,animatedRef:O(e,"animated"),mergedShowRef:r,nodePropsRef:O(e,"nodeProps"),renderOptionRef:O(e,"renderOption"),menuPropsRef:O(e,"menuProps"),doSelect:A,doUpdateShow:$}),ve(r,l=>{!e.animated&&!l&&B()});function A(l,w){const{onSelect:f}=e;f&&ce(f,l,w)}function $(l){const{"onUpdate:show":w,onUpdateShow:f}=e;w&&ce(w,l),f&&ce(f,l),o.value=l}function B(){n.value=null,d.value=null,c.value=null}function Q(){$(!1)}function ie(){G("left")}function Y(){G("right")}function ae(){G("up")}function de(){G("down")}function le(){const l=Z();l!=null&&l.isLeaf&&r.value&&(A(l.key,l.rawNode),$(!1))}function Z(){var l;const{value:w}=i,{value:f}=a;return!w||f===null?null:(l=w.getNode(f))!==null&&l!==void 0?l:null}function G(l){const{value:w}=a,{value:{getFirstAvailableNode:f}}=i;let p=null;if(w===null){const I=f();I!==null&&(p=I.key)}else{const I=Z();if(I){let s;switch(l){case"down":s=I.getNext();break;case"up":s=I.getPrev();break;case"right":s=I.getChild();break;case"left":s=I.getParent();break}s&&(p=s.key)}}p!==null&&(n.value=null,d.value=p)}const U=y(()=>{const{size:l,inverted:w}=e,{common:{cubicBezierEaseInOut:f},self:p}=_.value,{padding:I,dividerColor:s,borderRadius:g,optionOpacityDisabled:z,[L("optionIconSuffixWidth",l)]:j,[L("optionSuffixWidth",l)]:se,[L("optionIconPrefixWidth",l)]:M,[L("optionPrefixWidth",l)]:ze,[L("fontSize",l)]:Oe,[L("optionHeight",l)]:De,[L("optionIconSize",l)]:Ae}=p,m={"--n-bezier":f,"--n-font-size":Oe,"--n-padding":I,"--n-border-radius":g,"--n-option-height":De,"--n-option-prefix-width":ze,"--n-option-icon-prefix-width":M,"--n-option-suffix-width":se,"--n-option-icon-suffix-width":j,"--n-option-icon-size":Ae,"--n-divider-color":s,"--n-option-opacity-disabled":z};return w?(m["--n-color"]=p.colorInverted,m["--n-option-color-hover"]=p.optionColorHoverInverted,m["--n-option-color-active"]=p.optionColorActiveInverted,m["--n-option-text-color"]=p.optionTextColorInverted,m["--n-option-text-color-hover"]=p.optionTextColorHoverInverted,m["--n-option-text-color-active"]=p.optionTextColorActiveInverted,m["--n-option-text-color-child-active"]=p.optionTextColorChildActiveInverted,m["--n-prefix-color"]=p.prefixColorInverted,m["--n-suffix-color"]=p.suffixColorInverted,m["--n-group-header-text-color"]=p.groupHeaderTextColorInverted):(m["--n-color"]=p.color,m["--n-option-color-hover"]=p.optionColorHover,m["--n-option-color-active"]=p.optionColorActive,m["--n-option-text-color"]=p.optionTextColor,m["--n-option-text-color-hover"]=p.optionTextColorHover,m["--n-option-text-color-active"]=p.optionTextColorActive,m["--n-option-text-color-child-active"]=p.optionTextColorChildActive,m["--n-prefix-color"]=p.prefixColor,m["--n-suffix-color"]=p.suffixColor,m["--n-group-header-text-color"]=p.groupHeaderTextColor),m}),T=h?ao("dropdown",y(()=>`${e.size[0]}${e.inverted?"i":""}`),U,e):void 0;return{mergedClsPrefix:P,mergedTheme:_,tmNodes:t,mergedShow:r,handleAfterLeave:()=>{e.animated&&B()},doUpdateShow:$,cssVars:h?void 0:U,themeClass:T==null?void 0:T.themeClass,onRender:T==null?void 0:T.onRender}},render(){const e=(i,t,n,d,c)=>{var a;const{mergedClsPrefix:x,menuProps:b}=this;(a=this.onRender)===null||a===void 0||a.call(this);const S=(b==null?void 0:b(void 0,this.tmNodes.map(h=>h.rawNode)))||{},P={ref:bo(t),class:[i,`${x}-dropdown`,this.themeClass],clsPrefix:x,tmNodes:this.tmNodes,style:[...n,this.cssVars],showArrow:this.showArrow,arrowStyle:this.arrowStyle,scrollable:this.scrollable,onMouseenter:d,onMouseleave:c};return u(Ce,Se(this.$attrs,P,S))},{mergedTheme:o}=this,r={show:this.mergedShow,theme:o.peers.Popover,themeOverrides:o.peerOverrides.Popover,internalOnAfterLeave:this.handleAfterLeave,internalRenderBody:e,onUpdateShow:this.doUpdateShow,"onUpdate:show":void 0};return u(no,Object.assign({},oo(this.$props,Ro),r),{trigger:()=>{var i,t;return(t=(i=this.$slots).default)===null||t===void 0?void 0:t.call(i)}})}}),Bo="/img/desktop/logIn_mbd.png",To="/img/desktop/key_lemonsqueezy.png",Fo="/img/desktop/login_lemonsqueezy.png",jo="/img/desktop/mianbaoduo.png",Mo="/img/desktop/lemonsqueezy.png",Ko=D({__name:"Desktop",async setup(e){let o,r,i;try{const h=([o,r]=ge(()=>fetch("https://ad-api.nn.ci/v0/app/latest")),o=await o,r(),o);h.ok&&(i=([o,r]=ge(()=>h.json()),o=await o,r(),o).version)}catch(h){console.warn("Failed to fetch version:",h)}const t=[{key:"mac_arm64",label:"MacOS (Apple Silicon)",url:"https://bugo-1301111475.cos.ap-guangzhou.myqcloud.com/Alist/alist-desktop_aarch64.dmg"},{key:"mac_x64",label:"MacOS (Intel)",url:"https://bugo-1301111475.cos.ap-guangzhou.myqcloud.com/Alist/alist-desktop_x64.dmg"},{key:"win_x64",label:"Windows (X64)",url:"https://bugo-1301111475.cos.ap-guangzhou.myqcloud.com/Alist/alist-desktop_x64-setup.exe"},{key:"win_arm64",label:"Windows (ARM64)",url:"https://bugo-1301111475.cos.ap-guangzhou.myqcloud.com/Alist/alist-desktop_arm64-setup.exe"},{key:"linux",label:"Linux",url:"https://bugo-1301111475.cos.ap-guangzhou.myqcloud.com/Alist/alist-desktop_amd64.deb"}],n=navigator.platform.toLowerCase(),d=F("win_x64");n.includes("win")?d.value="win_x64":n.includes("linux")?d.value="linux":n.includes("mac")&&(d.value="mac_arm64"),console.log(d.value);let c={down:"Download",website:"Website"};const a=y(()=>{var h;return(h=t.find(_=>_.key===d.value))==null?void 0:h.label}),x=y(()=>t.map(h=>({...h,label:`${h.label} ${d.value===h.key?"✅":""}`})));location.pathname.startsWith("/zh/")&&(c={down:"下载",website:"官网"});function b(){var _;const h=(_=t.find(A=>A.key===d.value))==null?void 0:_.url;window.open(`${h}`,"_blank")}function S(h){d.value=h}function P(){window.open("https://desktop.alistgo.com/zh","_blank")}return(h,_)=>(so(),lo(C(ye),{align:"center",vertical:"",size:"large"},{default:E(()=>[q(C(ye),{class:"btn"},{default:E(()=>[q(C(ue),{size:"large",type:"info",onClick:P,tertiary:""},{default:E(()=>[pe(fe(C(c).website),1)]),_:1}),q(C(go),null,{default:E(()=>[q(C(Io),{trigger:"hover",options:x.value,onSelect:S,size:"large"},{default:E(()=>[q(C(ue),{size:"large",type:"primary",tertiary:""},{default:E(()=>[pe("💻"+fe(a.value),1)]),_:1})]),_:1},8,["options"]),q(C(ue),{size:"large",onClick:b,type:"info",secondary:""},{default:E(()=>[pe(fe(C(c).down),1)]),_:1})]),_:1})]),_:1}),q(C(fo),{src:"/img/guide/desktop.png"})]),_:1}))}}),Lo=uo(Ko,[["__scopeId","data-v-3d71b835"]]);export{Lo as D,To as _,Fo as a,Bo as b,Mo as c,jo as d};
